  ...
  return (
    <div className="h-[100dvh] w-full bg-black flex justify-center selection:bg-blue-500 selection:text-white">
      <div className="w-full max-w-md bg-gray-950 h-full relative flex flex-col overflow-hidden shadow-2xl">
        ...
        {/* HEADER NATIVO */}
        <header className="pt-safe bg-gray-950/90 backdrop-blur-2xl px-5 py-4 flex justify-between items-center border-b border-white/5 z-50 shrink-0">
          <div className="flex items-center gap-3">
            <div className={`w-9 h-9 rounded-[10px] flex items-center justify-center ${isPremium ? 'bg-linear-to-tr from-yellow-400 to-yellow-600 animate-pulse' : 'bg-linear-to-tr from-blue-500 to-blue-700'} shadow-lg`}>
          ...
          <button onClick={salir} className="w-10 h-10 flex items-center justify-center rounded-full bg-white/5 text-gray-400 hover:text-red-500 hover:bg-red-500/10 transition-all active:scale-90">
