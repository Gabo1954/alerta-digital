      ...
      <div className="w-full max-w-md bg-gray-950 h-full relative flex flex-col overflow-hidden shadow-2xl">
        ...
        <header className="pt-safe bg-gray-950/90 backdrop-blur-2xl border-b border-white/5 z-50 shrink-0 w-full">
          ...
          <div className="px-5 pt-3 pb-4 flex justify-between items-center w-full">
            ...
            {/*Logo y Textos*/}
            <button
              onClick={() => setTabActiva('inicio')} /* Cambia 'escaner' por el nombre exacto de tu pestaña de Análisis Inteligente si es distinto */
            ...
            {/*Botón Salir*/}
            <button onClick={salir} className="w-10 h-10 flex items-center justify-center rounded-full bg-white/5 text-gray-400 hover:text-red-500 hover:bg-red-500/10 transition-all active:scale-90 shrink-0">
