...
const Login = ({ onLoginSuccess, irARegistro }) => { 
    ...
    const manejarRecuperacion = async (e) => {
        ...
        try {
            ...
            // Opcional: limpiar el correo y volver al login después de un éxito
            // setTimeout(() => setVistaRecuperar(false), 3000); 
        } catch (err) {
        ...
        return (
            <div className="min-h-[100dvh] flex items-center justify-center bg-black p-4 font-sans relative overflow-hidden">
                ...
                <div className="bg-gray-900/80 backdrop-blur-xl p-8 sm:p-10 rounded-[3rem] shadow-2xl w-full max-w-md border border-white/5 relative z-10 animate-fade-in-up">
                    <button 
                        onClick={() => { setVistaRecuperar(false); setError(''); setMensaje(''); }} 
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-400 text-sm font-medium leading-relaxed">
                            Ingresa el correo asociado a tu cuenta de Alerta Digital y te enviaremos instrucciones para restablecer tu contraseña.
                        </p>
                    </div>
                    ...
                    {mensaje && (
                        <div className="bg-green-500/10 border-l-4 border-green-500 text-green-400 px-4 py-3 rounded-xl mb-6 text-xs font-bold animate-fade-in flex items-center gap-2">
                    ...
                    <form onSubmit={manejarRecuperacion} className="space-y-4">
                        ...
                        <button 
                            type="submit" 
                            disabled={cargando} 
                            className="w-full font-black py-4 rounded-2xl bg-blue-600 hover:bg-blue-500 text-white shadow-[0_0_20px_rgba(37,99,235,0.4)] transition-all active:scale-95 uppercase tracking-wider flex justify-center items-center gap-2 disabled:opacity-50 mt-2"
                        >
            ...
            <div className="bg-gray-900/80 backdrop-blur-xl p-8 sm:p-10 rounded-[3rem] shadow-2xl w-full max-w-md border border-white/5 relative z-10 animate-fade-in-up">
                ...
                <form onSubmit={manejarSubmit} className="space-y-4">
                    ...
                    <div className="flex justify-end">
                        <button 
                            type="button" 
                            onClick={() => { setVistaRecuperar(true); setError(''); setMensaje(''); }}
